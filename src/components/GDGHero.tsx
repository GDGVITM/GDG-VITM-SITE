...
export default function Hero() {
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#F8F9FA] bg-grid-pattern pt-20">
      ...
      >
        <div className="flex">
          <div className="w-16 h-16 md:w-24 md:h-24 bg-[#B6FF00]"></div>
      ...
      <div className="relative z-10 w-full max-w-[1400px] px-6 flex flex-col items-center">
        ...
        <motion.h2
          ...
          className="text-[32px] md:text-[48px] font-medium text-black tracking-tight mb-12 md:mb-20 text-center"
        >
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-8 md:gap-0">
          ...
          <motion.div
            ...
            className="w-full md:w-1/3 flex justify-center my-12 md:my-0 h-full py-10"
          >
            <div className="relative w-[300px] h-[300px] md:w-[380px] md:h-[380px] bg-white rounded-[60px] shadow-[0_40px_100px_rgba(0,0,0,0.08)] border border-gray-100/50 flex items-center justify-center p-12 cursor-none group">
        ...
        <motion.p
          ...
          className="mt-20 md:mt-32 text-center text-[14px] md:text-[16px] font-medium text-black/70 max-w-[500px] leading-relaxed"
        >
