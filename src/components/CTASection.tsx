...
export default function CTASection() {
    ...
    return (
        <motion.section
            ref={sectionRef}
            id="cta-section"
            className="relative w-full bg-[#0d0e0d] min-h-screen overflow-hidden flex items-center justify-center scanlines"
            style={{ "--parallax-bg-y": bgYString } as any}
        >
            <div className="absolute inset-0 bg-grid-pattern opacity-40" />

            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(182,255,0,0.04)_0%,transparent_60%)]" />
            ...
            <motion.div
                ...
                className="absolute w-[500px] h-[500px] rounded-full border border-[#B6FF00]/10 pointer-events-none"
            />
            <motion.div
                animate={{ scale: [1, 1.1, 1], opacity: [0.2, 0.3, 0.2] }}
                transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                className="absolute w-[800px] h-[800px] rounded-full border border-white/[0.03] pointer-events-none"
            />
            ...
            <div className="relative z-20 text-center px-6 max-w-[1000px] mx-auto">
                ...
                >
                    {[...Array(8)].map((_, i) => (
                        ...
                        >
                            <ChevronLeft className="w-6 h-6 text-white/10" />
                        </motion.div>
                    ))}
                </motion.div>
                ...
                <motion.p
                    ...
                    className="mt-10 text-[16px] md:text-[18px] font-medium text-white/40 leading-relaxed max-w-[600px] mx-auto"
                >
